...
En server är en större och mer kapabel dator som används för att göra krävande beräkningar för att leverera massor med information snabbt.
...
* Man säger åt hur hemsidan ska se ut genom att sätta text inom taggar ( <tagg></tagg> ) 
...
Med versionshantering så kan man snabbt och lätt ändra fel och göra det snabbt.
